...
/**
 * 接入阿里IACS，以图片鉴定为例
 * 学习网址：https://www.kuangstudy.com/bbs/1327998141777072130
 */
public class Main {
    public static void main(String[] args) throws Exception {
        IClientProfile profile = DefaultProfile
                .getProfile("cn-shanghai", "accessKeyId", "secretId");
        DefaultProfile
        ...
        //设置图片链接。
        task.put("url", "https://picture-1256975408.cos.ap-chengdu.myqcloud.com/6949_0.jpg");
